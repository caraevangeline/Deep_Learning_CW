# -*- coding: utf-8 -*-
"""Coursework3_GoogleNet_MNIST.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qa1HfL02fGeJXmJFf9gNmoFR39SO07Wx
"""
...
with tf.device('/gpu:0'):
  model.fit(x_train_gray, y_train_cat, batch_size=128, epochs=100, validation_split=0.2,verbose=1,callbacks=callbacks)  # starts training
