...
#------------Display the shape of the features and labels of train and test data------#
...
def cnn_model_fn(features, labels, mode):
    ...
    #.... Input Layer....#
    input_height, input_width = 28, 28  #...(32,32 for Cifar 10 dataset)
    input_channels = 1                  #...(3 for Cifar 10 dataset)
...
mnist_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn,
                                          model_dir="/tmp/mnist_vgg13_model") #...(cifar10_vgg13_model for cifar 10)


#------------Give the input to the classifier--------------#
...
#------------Print the accuracy and loss of the test samples------#
eval_results = mnist_classifier.evaluate(input_fn=eval_input_fn)
print(eval_results)

#----------Output predicted and actual class of one test sample to observer the authenticty------# 
